...
variable "mgmt_image_offer" {
  description = "Datamotive Mangement Node Image Offer"
  default     = null 
  type        = string
}

variable "mgmt_image_sku" {
  description = "Datamotive Mangement Node Image SKU"
  default     = null 
  type        = string
}

variable "mgmt_image_id" {
  description = "Datamotive Mangement Node Image ID"
  default     = null 
  type        = string
}

variable "mgmt_plan_name" {
  description = "Datamotive Mangement Node Plan Name"
  default     = null 
  type        = string
}

variable "mgmt_plan_publisher" {
  description = "Datamotive Mangement Node Plan Publisher"
  default     = null 
  type        = string
}

variable "mgmt_plan_product" {
  description = "Datamotive Mangement Node Plan Product"
  default     = null 
  type        = string
}

variable "repl_image_offer" {
  description = "Datamotive Replication Node Image Offer"
  default     = null 
  type        = string
}
variable "repl_image_sku" {
  description = "Datamotive Replication Node Image SKU"
  default     = null 
  type        = string
}
variable "repl_image_id" {
  description = "Datamotive Replication Node Image ID"
  default     = null 
  type        = string
}

variable "repl_plan_name" {
  description = "Datamotive Replication Node Plan Name"
  default     = null 
  type        = string
}

variable "repl_plan_publisher" {
  description = "Datamotive Replication Node Plan Publisher"
  default     = null 
  type        = string
}

variable "repl_plan_product" {
  description = "Datamotive Replication Node Plan Product"
  default     = null 
  type        = string
}

variable "prep_image_offer" {
  description = "Datamotive Prep Node Image Offer"
  default     = null 
  type        = string
}
variable "prep_image_sku" {
  description = "Datamotive Prep Node Image SKU"
  default     = null 
  type        = string
}
variable "prep_image_id" {
  description = "Datamotive Prep Node Image ID"
  default     = null 
  type        = string
}

variable "prep_plan_name" {
  description = "Datamotive Mangement Node Plan Name"
  default     = null 
  type        = string
}

variable "prep_plan_publisher" {
  description = "Datamotive Mangement Node Plan Publisher"
  default     = null 
  type        = string
}

variable "prep_plan_product" {
  description = "Datamotive Mangement Node Plan Product"
  default     = null 
  type        = string
}