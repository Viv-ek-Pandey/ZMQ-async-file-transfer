...
# Execution Level: VM
# =================================
# This script is invoked before creating a snapshot of a protected workload.
#
...
# Variable to store the parsed JSON received from the workflow containing recovery entity details
INPUT_JSON=""
...
# Function to parse the JSON data received from the workflow
# $1 : JSON data
ParseJson() {
    local all_args="$*"
...
main() {
    ...
    log "Pre-VM Replication Script started at: $(date '+%Y-%m-%d %H:%M:%S')"
